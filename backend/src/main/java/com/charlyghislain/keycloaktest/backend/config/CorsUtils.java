...
public class CorsUtils {
    ...
    public static boolean isRequestedMethodAllowed(MultivaluedMap<String, String> headers, Collection<String> allowedMethods) {
    ...
    public static boolean isRequestedHeadersAllowed(MultivaluedMap<String, String> headers, Collection<String> allowedHeaders) {
    ...
    private static boolean isMethodAllowed(String method, Collection<String> allowedMethods) {
    ...
    private static boolean areRequestedHeadersAllowed(List<String> requestedHeaders, Collection<String> allowedHeaders) {
    ...
    private static boolean isRequestedHeaderAllowed(String header, Collection<String> allowedHeaders) {
